...
export default function Aboutxs() {
  return (
          ...
          <div className="col-lg-7 mt_md--40 mt_sm--40">
            ...
            >
              <div className="section-title">
                ...
                <p>
                Brindamos soluciones para que nuestros
clientes tengan acceso preciso y en tiempo
real a todos los datos de su empresa, tanto
